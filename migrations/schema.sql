...
--
-- Name: room_restriction room_restriction_reservations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: room_restriction room_restriction_restrictions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
